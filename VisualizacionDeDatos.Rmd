...
p1 <- ggplot(datos, aes(Escolaridad_madre_jefe)) + 
          ...
          ylim(0,5000) +
          labs(y="Frecuencia", x = "Escolaridad madre jefe", title="Grado satisfaccion de vida pareja") 
...
p2 <- ggplot(datos, aes(Escolaridad_madre_pareja)) + 
          ...
          theme(axis.text.x = element_text(angle = 45, hjust = 1),
                plot.margin = margin(0,0,2,1, "cm")) +
          ylim(0,5000) +
          labs(y="Frecuencia", x = "Escolaridad madre pareja", title="Grado satisfaccion de vida jefe")
...
p3 <- ggplot(datos, aes(Escolaridad_padre_jefe)) + 
          ...
          theme(axis.text.x = element_text(angle = 45, hjust = 1),
                plot.margin = margin(0,0,2,1, "cm")) +
          ylim(0,5000) +
          labs(y="Frecuencia", x = "Escolaridad padre jefe", title="Grado satisfaccion de vida pareja") 
...
p4 <- ggplot(datos, aes(Escolaridad_padre_pareja)) + 
          ...
          theme(axis.text.x = element_text(angle = 45, hjust = 1),
                plot.margin = margin(0,0,2,1, "cm")) +
          ylim(0,5000) +
          labs(y="Frecuencia", x = "Escolaridad padre pareja", title="Grado satisfaccion de vida jefe")
...
ggplot(data = datos) + 
  geom_count(aes(Nivel_educativo_jefe,Hijos)) + 
...
```{r,warning=FALSE,message=FALSE,fig.width=8,fig.height=4}
ggplot(data = datos) + 
  geom_bin2d(aes(Nivel_educativo_jefe, Hijos,colour=factor(Estado_civil_jefe))) +
  ggtitle ("Hijos por nivel educativo/Distinción por Estado Civil") + 
  labs(x = "Nivel Educativo jefe",y = "Hijos") + 
